 ...
 */
class PractitionerRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function add(Practitioner $entity, bool $flush = false): void
    {
    ...
    public function remove(Practitioner $entity, bool $flush = false): void
    {
